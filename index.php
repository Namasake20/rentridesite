...
<header id="header" class="fixed-top">
 ...
 <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <div class="row">
      	<div class="col-6">
      		<h1>Welcome to RentARide</h1>
      		<h2>We offer the best services when it comes to car rental services.</h2>
			  ...
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      ...
			      <div class="carousel-caption d-none d-md-block">
			        <h5 style="color: #02021E ">Quality cars.</h5>
			    ...
			    <div class="carousel-item">
			      ...
			      <div class="carousel-caption d-none d-md-block">
			        <h5 style="color: #D35400 ">Best cars in market.</h5>
			    ...
			    <div class="carousel-item">
			      ...
			      <div class="carousel-caption d-none d-md-block">
			        <h5 style="color: #C0392B;font-weight: 20px">Electric cars</h5>
